...
print("Theoretical gradient-B drift velocity:")
...
print()
print("========== GRADIENT-B DRIFT SIMULATION ==========")
...
print("Initial guiding center:")
print(guiding_centers[0])

print()
print("Final guiding center:")
print(guiding_centers[-1])

print()
print("Measured guiding center drift velocity:")
...
print()
print("Gradient-B drift velocity error:")
print(drift_error)